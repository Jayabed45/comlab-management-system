    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <nav id="sidebar" class="sidebar w-64 bg-red-700 text-white p-6 flex flex-col overflow-y-auto shadow-lg">
            ...
            <ul class="flex-grow space-y-2">
                ...
                <li>
                    <a href="equipment_list.php" class="flex items-center p-3 rounded-lg hover:bg-red-600 transition-colors duration-200<?php if(basename($_SERVER['PHP_SELF'])=='equipment_list.php'){echo ' bg-red-800';} ?>">
