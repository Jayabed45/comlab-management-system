...
$result = $conn->query("SELECT DISTINCT r.*, p.pc_id, p.pc_number, p.is_active, p.cpu, p.ram, p.storage, p.gpu, p.os 
                       FROM rooms r 
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                <?php foreach ($room['pcs'] as $pc): ?>
                                    <div class="flex flex-col md:flex-row md:items-center justify-between p-3 bg-gray-50 rounded-lg mb-2">
                                        ...
                                        <div class="grid grid-cols-2 md:grid-cols-5 gap-2 text-xs text-gray-600 ml-7 md:ml-0">
